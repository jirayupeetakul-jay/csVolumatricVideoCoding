...
simulation_parameter.color_mode                      = 'already_gray';
...
%             end
            ...
            for k = 1:plane
                for z = 1:simulation_parameter.m
                    %___Forward WHT___
                    [r, c]                                  = size(y.sub_frame(:,:,k,z));
                    y.forward_wht_c                         = fwht(y.sub_frame(:,:,k,z));
                    y.forward_wht_r                         = fwht(y.forward_wht_c');
                    y.forward_wht                           = y.forward_wht_r';
                    %___Trancatint coefficient WHT
                    y.forward_wht(r/2:r,c/2:c)              = 0;
                    
                    y.inv_wht_c                             = ifwht(y.forward_wht);
                    y.inv_wht_r                             = ifwht(y.inv_wht_c');
                    y.decoded_sub_frame(:,:,k,z)            = y.inv_wht_r';
                end
            end
            disp('Done');
