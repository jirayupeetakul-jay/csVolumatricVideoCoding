        ...
        function intra_prediction_candidate=sum_of_absolute_difference(c1,c2,c3,c4,c5,c6,c7,c8,c9,sub_frame_temp)
            ...
            switch min_SAD
                case 1
                    ...
                    intra_prediction_candidate=floor(c1);
                    intra_mode='Mode 1';
                case 2
                    fprintf('Horizonatal Replication \n');
                    intra_prediction_candidate=floor(c2);
                    intra_mode='Mode 2';
                case 3
                    fprintf('Mean/DC \n');
                    intra_prediction_candidate=floor(c3);
                    intra_mode='Mode 3';
                case 4
                    fprintf('Diagonal Down-Left \n');
                    intra_prediction_candidate=floor(c4);
                    intra_mode='Mode 4';
                case 5
                    fprintf('Diagonal Down-Right \n');
                    intra_prediction_candidate=floor(c5);
                    intra_mode='Mode 5';
                case 6
                    fprintf('Vertical Right \n');
                    intra_prediction_candidate=floor(c6);
                    intra_mode='Mode 6';
                case 7
                    fprintf('Horizontal Down \n');
                    intra_prediction_candidate=floor(c7);
                    intra_mode='Mode 7';
                case 8
                    fprintf('Vertical Left \n');
                    intra_prediction_candidate=floor(c8);
                    intra_mode='Mode 8';
                case 9
                    fprintf('Horizontal Up \n');
                    intra_prediction_candidate=floor(c9);
                    intra_mode='Mode 9';
            end
        end
   end
